...
func AddUserToGroup(manager, groupID, username string) models.UserResponse {
	...
	return models.UserResponse{Message: "User added to group successfully", Status: "success"}
}
...
func RemoveUserFromGroup(manager, groupID, username string) models.UserResponse {
	...
	return models.UserResponse{Message: "User removed from group successfully", Status: "success"}
}
